...
- (void) sendImpression:(CDVInvokedUrlCommand *)command {
    ...
    if (!self.SST) {
      pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"[SST] Not inited. Please init first."];
    } else if (contentId != nil && [contentId length]) {
